...
# NOTE
# It is important that everything is the same datatype, because then getting values as np array is than free
...
def remove_paused_datapoints(data):
    ...
    is_paused = time < 0.0001 # time does not cahnge, game is paused 
