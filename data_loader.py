...
def run_cluster_calculate_norm_stats():
    ...
    H5_PATH_PREFIX = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/parse_job_out/parsed_files/"
    H5_PATH_PREFIX = '/mnt/lustre/groups/cs-dclabs-2019/esport/death_prediction/data/parse_job_out/parsed_files/'
    H5_FILE_LIST = "/users/rjs623/scratch/esport/death_prediction/all_h5_files.txt"
    
    now = time.time()

    #h5_files = get_h5_file_list(H5_PATH_PREFIX,H5_FILE_LIST)
    h5_files = glob.glob(H5_PATH_PREFIX + '*.h5')
    print(h5_files)
...
def run_cluster_randomize(data_type):
    ...
    if data_type == "train":
        H5_PATH_PREFIX = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/parse_job_out/parsed_files/"
        H5_FILE_LIST = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/training_files.txt"
        OUT_FOLDER = "/mnt/lustre/groups/cs-dclabs-2019/esport/death_prediction_data/randomized_data/train/"

    elif data_type == "test":
        H5_PATH_PREFIX = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/parse_job_out/parsed_files/"
        H5_FILE_LIST = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/test_files.txt"
        OUT_FOLDER = "/mnt/lustre/groups/cs-dclabs-2019/esport/death_prediction_data/randomized_data/test/"

    elif data_type == "validation":
        H5_PATH_PREFIX = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/parse_job_out/parsed_files/"
        H5_FILE_LIST = "/users/rjs623/scratch/esport/death_prediction/cluster_scripts/validation_files.txt"
...
def getFeatureIndiciesMinimal(data):
    only_include_list = []
    only_include_list.append("time")
    only_include_list.append("flAgilityTotal")
    only_include_list.append("flIntellectTotal")
    only_include_list.append("flStrengthTotal")
    only_include_list.append("flMagicalResistanceValue")
    only_include_list.append("flPhysicalArmorValue")
    only_include_list.append("flMana")
    only_include_list.append("iHealth")
    only_include_list.append("lifeState")
    only_include_list.append("iTotalEarnedGold")
    only_include_list.append("iTotalEarnedXP")
    only_include_list.append("m_iTaggedAsVisibleByTeam")
    only_include_list.append("m_iLevel")
    only_include_list.append("m_iKills")

    only_include_list.append("_pos_") # 2 x,y
...
def getFeatureIndiciesSmall(data):
    only_include_list = []
    only_include_list.append("time")
    only_include_list.append("flAgilityTotal")
    only_include_list.append("flIntellectTotal")
    ...
    only_include_list.append("m_iDeaths")
    only_include_list.append("m_iAssists")

    only_include_list.append("_pos_") # 2 x,y
    only_include_list.append("_speed_") # 2 x,y

    only_include_list.append("_proximity_") # 9 ally and enemy + 9 delta if not excluded
    only_include_list.append("closest_tower_distance") # 2 ally and enemy + 2 delta if not excluded

    only_include_list.append("_visibility_history_") # 10, the past in one second intervals
...
# this is basically the small + all the other questionable usefullness features
def getFeatureIndiciesNoAbilityNoHeroNoItems(data): 
    exclude_if_contains_list = []
    exclude_if_contains_list.append("_ability_") # all ability features
    exclude_if_contains_list.append("_hero_one_hot_") # hero id
    exclude_if_contains_list.append("nSelectedHeroID") # TODO handle this
    exclude_if_contains_list.append("_item_") # soon
    return getFeatureIndicies(data,exclude_if_contains_list)

def getFeatureIndiciesNoAbilityNoHero(data): 
    exclude_if_contains_list = []
    exclude_if_contains_list.append("_ability_") # all ability features
    exclude_if_contains_list.append("_hero_one_hot_") # hero id
    exclude_if_contains_list.append("nSelectedHeroID") # TODO handle this
...
def getFeatureIndiciesAll(data):
